...
public class ServiceTypesController {
    ...
    private String pathView = "admin/servicetypes";
    private final ServiceTypeRepository _repository;
    ...
    public ServiceTypesController (
        ServiceTypeRepository _repository, 
    ...
    public ModelAndView list(){
        ...
        view.addObject("ServiceTypes", _repository.findAll());
    ...
    public ModelAndView create(ServiceType itemTocreate) {
    ...
    public ModelAndView store(@Valid ServiceType itemTocreate, BindingResult result, Model model ) {
        ...
        try {
            ...
            view.setViewName("redirect:/servicetypes");
            return view;
    ...
    public ModelAndView edit(@PathVariable("id") Integer id,Model model ) {
        ...
        ModelAndView view = new ModelAndView();
        ServiceType itemToEdit = findById(id);
        view.addObject("serviceType", itemToEdit);
    ...
    public ModelAndView update(@PathVariable("id") Integer id, @Valid ServiceType itemToEdit,BindingResult result, Model model) {
    ...
    public @ResponseBody String delete(@PathVariable("id") Integer id,Model model) {
        ...
        try {
            ServiceType itemToDelete = findById(id);
    ...
    public @ResponseBody String enable(@PathVariable("id") Integer id, Model model) {
        try {
            ServiceType itemToActive = findById(id);
     ...
     */
    private ServiceType findById(int id) {
