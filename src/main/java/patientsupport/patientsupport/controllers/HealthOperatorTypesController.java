 ...
 */
@Controller
@RequestMapping("healthoperatortypes")
public class HealthOperatorTypesController {

    private String pathView = "admin/healthoperatortypes";
    private final HealthOperatorTypeRepository _repository;
     ...
     */
    @Autowired
    public HealthOperatorTypesController (
        HealthOperatorTypeRepository _repository, 
    ...
    public ModelAndView list(){
        ...
        view.addObject("HealthOperatorTypes", _repository.findAll());
    ...
    public ModelAndView create(HealthOperatorType itemTocreate) {
    ...
    public ModelAndView store(@Valid HealthOperatorType itemTocreate, BindingResult result, Model model ) {
        ...
        try {
            ...
            view.setViewName("redirect:/healthoperatortypes");
            return view;
    ...
    public ModelAndView edit(@PathVariable("id") Integer id,Model model ) {
        ...
        ModelAndView view = new ModelAndView();
        HealthOperatorType itemToEdit = findById(id);
        view.addObject("healthOperatorType", itemToEdit);
    ...
    public ModelAndView update(@PathVariable("id") Integer id, @Valid HealthOperatorType itemToEdit,BindingResult result, Model model) {
    ...
    public @ResponseBody String delete(@PathVariable("id") Integer id,Model model) {
        ...
        try {
            HealthOperatorType itemToDelete = findById(id);
    ...
    public @ResponseBody String enable(@PathVariable("id") Integer id, Model model) {
        try {
            HealthOperatorType itemToActive = findById(id);
     ...
     */
    private HealthOperatorType findById(int id) {
