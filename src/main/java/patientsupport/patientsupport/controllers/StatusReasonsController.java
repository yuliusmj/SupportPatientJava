 ...
 */
@Controller
@RequestMapping("statusreasons")
public class StatusReasonsController {

    private String pathView = "admin/statusreasons";
    private final StatusReasonRepository _repository;
     ...
     */
    @Autowired
    public StatusReasonsController (
        StatusReasonRepository _repository, 
    ...
    public ModelAndView list(){
        ...
        view.addObject("StatusReasons", _repository.findAll());
    ...
    public ModelAndView create(StatusReason itemTocreate) {
    ...
    public ModelAndView store(@Valid StatusReason itemTocreate, BindingResult result, Model model ) {
        ...
        try {
            ...
            view.setViewName("redirect:/statusreasons");
            return view;
    ...
    public ModelAndView edit(@PathVariable("id") Integer id,Model model ) {
        ...
        ModelAndView view = new ModelAndView();
        StatusReason itemToEdit = findById(id);
        view.addObject("status", statusRepository.findAll());
        view.addObject("statusReason", itemToEdit);
    ...
    public ModelAndView update(@PathVariable("id") Integer id, @Valid StatusReason itemToEdit,BindingResult result, Model model) {
    ...
    public @ResponseBody String delete(@PathVariable("id") Integer id,Model model) {
        ...
        try {
            StatusReason itemToDelete = findById(id);
    ...
    public @ResponseBody String enable(@PathVariable("id") Integer id, Model model) {
        try {
            StatusReason itemToActive = findById(id);
     ...
     */
    private StatusReason findById(int id) {
