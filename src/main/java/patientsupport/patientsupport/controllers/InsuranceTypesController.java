...
public class InsuranceTypesController {
    ...
    private String pathView = "admin/insurancetypes";
    private final InsuranceTypeRepository _repository;
    ...
    public InsuranceTypesController (
        InsuranceTypeRepository _repository, 
    ...
    public ModelAndView list(){
        ...
        view.addObject("InsuranceTypes", _repository.findAll());
    ...
    public ModelAndView create(InsuranceType itemTocreate) {
    ...
    public ModelAndView store(@Valid InsuranceType itemTocreate, BindingResult result, Model model ) {
        ...
        try {
            ...
            view.setViewName("redirect:/insurancetypes");
            return view;
    ...
    public ModelAndView edit(@PathVariable("id") Integer id,Model model ) {
        ...
        ModelAndView view = new ModelAndView();
        InsuranceType itemToEdit = findById(id);
        view.addObject("insuranceType", itemToEdit);
    ...
    public ModelAndView update(@PathVariable("id") Integer id, @Valid InsuranceType itemToEdit,BindingResult result, Model model) {
    ...
    public @ResponseBody String delete(@PathVariable("id") Integer id,Model model) {
        ...
        try {
            InsuranceType itemToDelete = findById(id);
    ...
    public @ResponseBody String enable(@PathVariable("id") Integer id, Model model) {
        try {
            InsuranceType itemToActive = findById(id);
     ...
     */
    private InsuranceType findById(int id) {
