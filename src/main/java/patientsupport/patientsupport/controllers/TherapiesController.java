...
public class TherapiesController {
    ...
    private String pathView = "admin/therapies";
    private final TherapyRepository _repository;
    ...
    public ModelAndView list(){
        ...
        view.addObject("Therapies", _repository.findAll());
    ...
    public ModelAndView create(Therapy itemTocreate) {
    ...
    public ModelAndView store(@Valid Therapy itemTocreate, BindingResult result, Model model ) {
        ...
        try {
            ...
            view.setViewName("redirect:/therapies");
            return view;
    ...
    public ModelAndView edit(@PathVariable("id") Integer id,Model model ) {
        ...
        ModelAndView view = new ModelAndView();
        Therapy itemToEdit = findById(id);
        view.addObject("therapy", itemToEdit);
    ...
    public ModelAndView update(@PathVariable("id") Integer id, @Valid Therapy itemToEdit,BindingResult result, Model model) {
    ...
    public @ResponseBody String delete(@PathVariable("id") Integer id,Model model) {
        ...
        try {
            Therapy itemToDelete = findById(id);
    ...
    public @ResponseBody String enable(@PathVariable("id") Integer id, Model model) {
        try {
            Therapy itemToActive = findById(id);
     ...
     */
    private Therapy findById(int id) {
